...
class Home extends Generic {
	...
	get $camisasBlusas() { 
		return $('[title="Camisas y blusas"]'); }
	get $collectionBox() { 
		return $('[data-vc-node-id="5"] [data-vc-node-html="5"]'); }
	get $responseMenu() { 
		return $('[data-uitest="navigateShowMenu"]'); }
	get $responseMujer() { 
		return $('[data-uitest="navigationPanelOption"] [alt="Mujer"]'); }
