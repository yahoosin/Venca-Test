...
class SelectedItem {
	...
	get $itemName () { 
		return $('[id="mainTextFeatures"] h1'); }
	get $responseItemName () {
		return $('[class="chooseFeatures"] h1'); }
	get $dropdownSizeButton () { 
		return $('[data-uitest="productSizeSelector"]'); } 
	get $dropdownSizeButtonResponse () {
		return $('[data-uitest="productSize"]'); } 
	get $selectSizeL () {
		return $('[data-id-for-select][data-id-for-select="L"]'); } 
	get $selectSizeLResponse () {
		return $('[data-id-for-select="L"]'); } 
	get $addButton () {
		return $('[data-uitest="productAddToCart"]'); } 
	get $addButtonResponse () {
		return $('[data-uitest="productAddToCart"]'); } 
	get $goToCart () { 
		return $('[id="cartZone"]'); }
	get $goToCartResponse () {
		return $('[id="cartZone"]'); }    
	get $color () {
